...
\begin{tikzpicture}[
sibling distance = 10em,
Livello1/.style={ellipse, draw, align=center},
Livello2/.style={rectangle, draw, align=center},]
\node[Livello1]{W X YYY ZZ }
	child{node[Livello2, text width=0.1\textwidth]{W: Simbolo iniziale}}
	child{node[Livello2, color=UnifeLight, text width=0.4\textwidth]{X: Simbolo impiego}}
	child{node[Livello2, text width=0.3\textwidth]{Y: Caratteristiche meccanico-fisiche}}
	child{node[Livello2, text width=0.2\textwidth]{Z: Altre indicazioni}};
\end{tikzpicture}
\end{figure}

%child{node[Livello1]{Simbolo\\Iniziale}
%		child{node[Livello2, text width = 0.1\textwidth]{%
%		\begin{description}
%		\item[G]: Acciaio per getti 
%		\item[PM]: metallurgia delle polveri
%		\end{description}}}}
%	child{node[Livello1]{Simbolo Impiego}
%		child{node[Livello2, text width = 0.4\textwidth]{%
%		\begin{description}
...
%		\item[\dots]
%		\end{description}}}}
%	child{node[Livello1]{Caratteristiche\\Meccaniche\\o Fisiche}
%		child{node[Livello2, text width=0.3\textwidth]{%
%		\begin{description}
%		\item[$R_{s,min}$] in $\left[ \unit{\MPa}\right]$
%		\item[$R_{m,min}$] in $\left[\unit{\MPa}\right]$
%		\item[$HBW_{min}$] (adimensionale)
%		\end{description}}}}
%	child{node[Livello1]{Altre\\Indicazioni}
%		child{node[Livello2, text width=0.2\textwidth]{Simboli addizionali divisi in due gruppi}}}